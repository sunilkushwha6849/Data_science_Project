...
def show():
    ...
    if chart_type == "Bar Chart":
        ...
        chart_data = (
        df.groupby(x_column)[y_column].mean().reset_index())
    ...
    if show_value:
        ...
        st.plotly_chart(fig, width="stretch",key="bar_chart")
    ...
    line=dict(
        ...
        st.plotly_chart(fig, width="stretch", key="line_chart")
        ...
        st.plotly_chart(fig, width="stretch",key="histogram")
        ...
        st.plotly_chart(fig, width="stretch",key="scatter_plot")
